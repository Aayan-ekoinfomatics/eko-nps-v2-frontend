            ...
            <div className='w-full'>
                ...
                <div className='w-full px-4'>
                    <div className='w-full flex flex-wrap xl:flex-nowrap gap-4'>
                        ...
                        {/* card 1 */}
                        <div className='w-full max-w-[600px] md:max-w-[100%] xl:max-w-[350px] gap-4 flex items-center border p-4 rounded-[10px]'>

                            {/* rating */}
                            <div className='w-fit md:w-[20%] lg:w-fit sm:ml-2'>
                                <h1 className=''>Rating</h1>
                                <div>
                                    <h1 className='text-3xl sm:text-5xl'>{ratingCardData?.rating?.toString()?.split('.')[0]}.<span className='text-xl sm:text-3xl'>{ratingCardData?.rating?.toString()?.split('.')[1]}</span></h1>
                                    ...
                                    <div className='flex'>
                                        {
                                            ratingCardData?.star === 1 ?
                                                <>
                                                    <StarRoundedIcon fontSize='small' className=' text-yellow-600' />
                            ...
                            <div className='w-full flex flex-col justify-start items-start gap-2'>
                                <div className='w-full text-[13px] bg-gray-200 rounded-[3px] flex gap-2 relative'><span className='absolute right-[4px] font-[600] text-gray-400 text-[11px] bottom-[10%]'>5 ★</span><div className='bg-[var(--secondary-color)] rounded-[3px] h-[20px] flex justify-start pt-1 items-center text-[13px] pl-2 text-gray-200' style={{ width: ratingCardData?._5 }}></div></div>
                                <div className='w-full text-[13px] bg-gray-200 rounded-[3px] flex gap-2 relative'><span className='absolute right-[4px] font-[600] text-gray-400 text-[11px] bottom-[10%]'>4 ★</span><div className='bg-[var(--secondary-color)] rounded-[3px] h-[20px] flex justify-start pt-1 items-center text-[13px] pl-2 text-gray-200' style={{ width: ratingCardData?._4 }}></div></div>
                                <div className='w-full text-[13px] bg-gray-200 rounded-[3px] flex gap-2 relative'><span className='absolute right-[4px] font-[600] text-gray-400 text-[11px] bottom-[10%]'>3 ★</span><div className='bg-[var(--secondary-color)] rounded-[3px] h-[20px] flex justify-start pt-1 items-center text-[13px] pl-2 text-gray-200' style={{ width: ratingCardData?._3 }}></div></div>
                                <div className='w-full text-[13px] bg-gray-200 rounded-[3px] flex gap-2 relative'><span className='absolute right-[4px] font-[600] text-gray-400 text-[11px] bottom-[10%]'>2 ★</span><div className='bg-[var(--secondary-color)] rounded-[3px] h-[20px] flex justify-start pt-1 items-center text-[13px] pl-2 text-gray-200' style={{ width: ratingCardData?._2 }}></div></div>
                                <div className='w-full text-[13px] bg-gray-200 rounded-[3px] flex gap-2 relative'><span className='absolute right-[4px] font-[600] text-gray-400 text-[11px] bottom-[10%]'>1 ★</span><div className='bg-[var(--secondary-color)] rounded-[3px] h-[20px] flex justify-start pt-1 items-center text-[13px] pl-2 text-gray-200' style={{ width: ratingCardData?._1 }}></div></div>
                            </div>
                        </div>
                        ...
                        <div className='w-full row-start-2 col-start-1 col-end-3 grid grid-cols-3 gap-4 '>
                            {
                                smallCardApiData?.map((data, i) => (
                                    <div key={i} className='border rounded-[10px] flex flex-col gap-4 justify-center items-center w-full'>
                                        <h1 className='text-xs pt-2 xl:pt-0 sm:text-sm text-gray-400 font-[500]'>{data?.title}</h1>
                                        {
                                            data?.title === 'Surveyed' ?

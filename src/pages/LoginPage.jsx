            ...
            <div className="w-full xl:min-w-[400px] max-w-[400px] bg-white px-6 py-8 rounded-[10px] shadow-md">
              ...
              <form onSubmit={login} className="w-full flex flex-col gap-5">
                ...
                <div className="w-full flex pt-4">
                  <button className="w-full hover:bg-[#1077aa] active:scale-95 transition-all duration-300 ease-in-out py-[10px] rounded-[10px] flex justify-center items-center text-[14px] font-[600] text-white bg-[var(--secondary-color)]">
                    LOGIN
                  </button>
                </div>
              </form>
